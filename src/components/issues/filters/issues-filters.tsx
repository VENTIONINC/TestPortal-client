...
export const IssuesFilters = (props: StackProps) => {
  ...
  //           label="Date range:"
  //           name="statDateRange"
  //           fromValue={localFilters.statFrom}
  //           toValue={localFilters.statTo}
  //           onChangeFrom={(value) => setLocalFilters((prev) => ({ ...prev, statFrom: value }))}
  //           onChangeTo={(value) => setLocalFilters((prev) => ({ ...prev, statTo: value }))}
  //         />
  //       </FiltersRow>
  //     </FiltersGroup>
  //   </FiltersContainer>
