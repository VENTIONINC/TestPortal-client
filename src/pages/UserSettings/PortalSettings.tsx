...
export function PortalSettings() {
  ...
  const { register, handleSubmit, watch } = useForm<PortalSettingsFormData>({
    ...
    defaultValues: {
      ...
      reportPortalEnabled: user.reportPortalEnabled,
      monitoringPortalEnabled: user.monitoringPortalEnabled,
    },
  });
        ...
        <VStack gap={6} align="stretch">
          ...
          <Box>
            <HStack justify="space-between" align="center" mb={3}>
              ...
              <Switch.Root size="sm" checked={watch('reportPortalEnabled')} {...register('reportPortalEnabled')}>
                <Switch.HiddenInput />
                <Switch.Control />
              </Switch.Root>
            </HStack>
