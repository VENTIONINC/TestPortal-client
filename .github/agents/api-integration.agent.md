...
description: RTK Query API integration expert. Specializes in endpoint management, authentication flows, caching strategies, and baseApi/mcpApi patterns.
tools: ['search', 'usages']
---
...
- Separate API instance for MCP (Model Control Protocol) endpoints
- Independent authentication handling

### Generated API Code

- Working with rtk-query-codegen-openapi generated types and endpoints
- Extending generated endpoints with custom logic
- Managing schema updates and regeneration workflows

### Redux Integration

- Proper integration with auth slice
- Token management and state updates
- Cache synchronization with Redux state

### Component Integration

- Connecting API hooks to React components
- Proper loading/error states
- Optimistic updates and user feedback

## API Integration Workflow

1. **Requirements Analysis**: Understand API endpoint requirements, data flow, and authentication needs
